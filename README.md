...
Ao carregar a página, você verá uma lista dos primeiros 150 Pokémons. Você pode clicar em qualquer um dos Pokémons para ver mais informações detalhadas sobre ele. Além disso, você pode usar a barra de pesquisa para procurar um Pokémon específico por número ou nome.

Se quiser adicionar um Pokémon à sua lista de favoritos, basta clicar no ícone de coração ao lado do nome do Pokémon. Você pode ver sua lista de favoritos clicando no botão "Favorites" na parte superior da página.
